class OrderForm
  ...
  attr_accessor :user_id, :item_id, :send_number :prefecture_id, :city, :address, :building, :phone_number, :token
  ...
  def save
    ...
    Payment.create(order_id: order.id, send_number: send_number, area_id: area_id, city: city, address: address, building: building, phone_number: phone_number)
  end
end